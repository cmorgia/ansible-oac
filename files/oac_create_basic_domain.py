...
print "[WARN] Remove default server 'oac_server1' created by the OAC tempalte"
delete('oac_server1', 'Server')

print '[INFO] Create OAC cluster'
...
for i in range(len(machines)):
    ...
    for j in range(int(managed_servers_per_machine)):
        ...
        cd('../..')
        #print "[INFO] [%s,%s] Set server group" % (managed_server_name,server_groups)
